...
# Form implementation generated from reading ui file 'uis/exam_dw.ui'
#
# Created: Sat Jun 23 23:33:41 2018
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.edite_btn.setIconSize(QtCore.QSize(25, 25))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/n/img/line-chart.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.details_btn.setIcon(icon2)
        self.details_btn.setIconSize(QtCore.QSize(25, 25))
        ...
        self.gridLayout_2.addWidget(self.details_edt, 5, 0, 1, 1)
        ...
        self.max_spn = QtGui.QDoubleSpinBox(self.widget_3)
        self.max_spn.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.max_spn.setAlignment(QtCore.Qt.AlignCenter)
        self.max_spn.setObjectName("max_spn")
        self.gridLayout_2.addWidget(self.max_spn, 4, 0, 1, 1)
        ...
        self.widget_16 = QtGui.QWidget(self.widget_3)
        self.widget_16.setObjectName("widget_16")
        self.gridLayout_4 = QtGui.QGridLayout(self.widget_16)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.gridLayout_2.addWidget(self.widget_16, 7, 0, 1, 2)
        ...
        Form.setTabOrder(self.hours_spn, self.max_spn)
        Form.setTabOrder(self.max_spn, self.details_edt)
        Form.setTabOrder(self.details_edt, self.add_btn)
        Form.setTabOrder(self.add_btn, self.edite_btn)

    def retranslateUi(self, Form):
        Form.setWindowTitle(QtGui.QApplication.translate("Form", "الاختبارات", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("Form", "عدد الايام", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("Form", "الدرجة العظمى", None, QtGui.QApplication.UnicodeUTF8))
        self.class_rd.setText(QtGui.QApplication.translate("Form", "دورى", None, QtGui.QApplication.UnicodeUTF8))
        self.month_rd.setText(QtGui.QApplication.translate("Form", "شهرى", None, QtGui.QApplication.UnicodeUTF8))
